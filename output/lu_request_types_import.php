...
// keys array
$keys[]=AddFieldWrappers("RequestTypeId");
$keys_present=1;
...
function ImportFromExcel($uploadfile)
{
	...
	for($k=0; $k<count($keys); $k++)
	{
		...
		if(in_array("RequestTypeId",$fields))
		$autoinc=true;
...
$layout->blocks["top"][] = "import";$page_layouts["lu_request_types_import"] = $layout;
...
$xt->display("lu_request_types_import.htm");
