...
$layout->blocks["top"][] = "pdf";$page_layouts["lu_initiating_gurus_print"] = $layout;
...
//	GurumaharajId - 
			$record["GurumaharajId_value"] = $pageObject->showDBValue("GurumaharajId", $data, $keylink);
			$record["GurumaharajId_class"] = $pageObject->fieldClass("GurumaharajId");
//	Name - 
...
$xt->assign("GurumaharajId_fieldheadercolumn",true);
$xt->assign("GurumaharajId_fieldheader",true);
$xt->assign("GurumaharajId_fieldcolumn",true);
$xt->assign("GurumaharajId_fieldfootercolumn",true);
