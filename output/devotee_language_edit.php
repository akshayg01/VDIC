...
$layout->blocks["top"][] = "details";$page_layouts["devotee_language_edit"] = $layout;
...
$templatefile = ($inlineedit == EDIT_INLINE) ? "devotee_language_inline_edit.htm" : "devotee_language_edit.htm";
...
$skeys = "";
$savedKeys = array();
$keys["DevoteeLanguageId"] = urldecode(postvalue("editid1"));
$savedKeys["DevoteeLanguageId"] = urldecode(postvalue("editid1"));
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// key get query
	$keyGetQ = "";
		$keyGetQ.="editid1=".rawurldecode($keys["DevoteeLanguageId"])."&";
	// cut last &
	$keyGetQ = substr($keyGetQ, 0, strlen($keyGetQ)-1);	
	// redirect
	header("Location: devotee_language_".$pageObject->getPageType().".php?".$keyGetQ);
...
if($inlineedit != EDIT_INLINE)
{
	...
	if(isEnableSection508())
		$xt->assign_section("SpeakingLevel_label","<label for=\"".GetInputElementId("SpeakingLevel", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("ReadingLevel_label","<label for=\"".GetInputElementId("ReadingLevel", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("WritingLevel_label","<label for=\"".GetInputElementId("WritingLevel", $id, PAGE_EDIT)."\">","</label>");
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='devotee_language_view.php?".$viewlink."'\"");
