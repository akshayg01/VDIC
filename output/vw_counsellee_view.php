...
$layout->blocks["top"][] = "details";$page_layouts["vw_counsellee_view"] = $layout;
...
//LanguageId - 
	...
	if($mainTableOwnerID=="LanguageId")
		$ownerIdValue=$value;
	$xt->assign("LanguageId_value",$value);
...
//WritingLevel - 
	...
	if($mainTableOwnerID=="WritingLevel")
		$ownerIdValue=$value;
	$xt->assign("WritingLevel_value",$value);
...
//ReadingLevel - 
	...
	if($mainTableOwnerID=="ReadingLevel")
		$ownerIdValue=$value;
	$xt->assign("ReadingLevel_value",$value);
...
//SpeakingLevel - 
	...
	if($mainTableOwnerID=="SpeakingLevel")
		$ownerIdValue=$value;
	$xt->assign("SpeakingLevel_value",$value);
...
//DevoteeId2 - 
	...
	if($mainTableOwnerID=="DevoteeId2")
		$ownerIdValue=$value;
	$xt->assign("DevoteeId2_value",$value);
	if(!$pageObject->isAppearOnTabs("DevoteeId2"))
		$xt->assign("DevoteeId2_fieldblock",true);
	else
		$xt->assign("DevoteeId2_tabfieldblock",true);
////////////////////////////////////////////
//DevoteeLanguageId - 
	
	$value = $pageObject->showDBValue("DevoteeLanguageId", $data, $keylink);
	if($mainTableOwnerID=="DevoteeLanguageId")
		$ownerIdValue=$value;
	$xt->assign("DevoteeLanguageId_value",$value);
	if(!$pageObject->isAppearOnTabs("DevoteeLanguageId"))
		$xt->assign("DevoteeLanguageId_fieldblock",true);
	else
		$xt->assign("DevoteeLanguageId_tabfieldblock",true);
////////////////////////////////////////////
//MotherName - 
	
	$value = $pageObject->showDBValue("MotherName", $data, $keylink);
	if($mainTableOwnerID=="MotherName")
		$ownerIdValue=$value;
	$xt->assign("MotherName_value",$value);
...
//FatherName - 
	...
	if($mainTableOwnerID=="FatherName")
		$ownerIdValue=$value;
	$xt->assign("FatherName_value",$value);
...
//DevoteeExtraInfoId - 
	...
	if($mainTableOwnerID=="DevoteeExtraInfoId")
		$ownerIdValue=$value;
	$xt->assign("DevoteeExtraInfoId_value",$value);
	if(!$pageObject->isAppearOnTabs("DevoteeExtraInfoId"))
		$xt->assign("DevoteeExtraInfoId_fieldblock",true);
	else
		$xt->assign("DevoteeExtraInfoId_tabfieldblock",true);
////////////////////////////////////////////
//TitleId - 
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='vw_counsellee_edit.php?".$editlink."'\"");
