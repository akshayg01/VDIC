...
// keys array
$keys[]=AddFieldWrappers("PaymentModeId");
$keys_present=1;
...
function ImportFromExcel($uploadfile)
{
	...
	for($k=0; $k<count($keys); $k++)
	{
		...
		if(in_array("PaymentModeId",$fields))
		$autoinc=true;
...
$layout->blocks["top"][] = "import";$page_layouts["lu_payment_modes_import"] = $layout;
...
$xt->display("lu_payment_modes_import.htm");
