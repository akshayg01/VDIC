...
$layout->blocks["top"][] = "export";$page_layouts["vw_counsellee_export"] = $layout;
...
$xt->display("vw_counsellee_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=vw_counsellee.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=vw_counsellee.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=vw_counsellee.xml");
	...
	while((!$nPageSize || $i<$nPageSize) && $row)
	{
		$values = array();
			...
			$values["CounsellorDevoteeID"] = $pageObject->showDBValue("CounsellorDevoteeID", $row);
			$values["DevoteeExtraInfoId"] = $pageObject->showDBValue("DevoteeExtraInfoId", $row);
			$values["DevoteeId1"] = $pageObject->showDBValue("DevoteeId1", $row);
			$values["NativeCity"] = $pageObject->showDBValue("NativeCity", $row);
			$values["NativeState"] = $pageObject->showDBValue("NativeState", $row);
			$values["BloodGroup"] = $pageObject->showDBValue("BloodGroup", $row);
			$values["FatherName"] = $pageObject->showDBValue("FatherName", $row);
			$values["MotherName"] = $pageObject->showDBValue("MotherName", $row);
			$values["DevoteeLanguageId"] = $pageObject->showDBValue("DevoteeLanguageId", $row);
			$values["DevoteeId2"] = $pageObject->showDBValue("DevoteeId2", $row);
			$values["SpeakingLevel"] = $pageObject->showDBValue("SpeakingLevel", $row);
			$values["ReadingLevel"] = $pageObject->showDBValue("ReadingLevel", $row);
			$values["WritingLevel"] = $pageObject->showDBValue("WritingLevel", $row);
			$values["LanguageId"] = $pageObject->showDBValue("LanguageId", $row);
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=vw_counsellee.csv");
...
// write header
	...
	if($outstr!="")
		$outstr.=",";
	$outstr.= "\"CounsellorDevoteeID\"";
	if($outstr!="")
		$outstr.=",";
	$outstr.= "\"DevoteeExtraInfoId\"";
	if($outstr!="")
		$outstr.=",";
	$outstr.= "\"DevoteeId1\"";
	if($outstr!="")
	...
	if($outstr!="")
		$outstr.=",";
	$outstr.= "\"DevoteeLanguageId\"";
	if($outstr!="")
		$outstr.=",";
	$outstr.= "\"DevoteeId2\"";
	if($outstr!="")
		$outstr.=",";
	$outstr.= "\"SpeakingLevel\"";
	if($outstr!="")
		$outstr.=",";
	$outstr.= "\"ReadingLevel\"";
	if($outstr!="")
...
// write data rows
	...
	while((!$nPageSize || $iNumberOfRows < $nPageSize) && $row)
	{
		...
		$values["Photo"] = "LONG BINARY DATA - CANNOT BE DISPLAYED";
			...
			$values["CounsellorDevoteeID"] = $pageObject->getViewControl("CounsellorDevoteeID")->showDBValue($row, "");
			$values["DevoteeExtraInfoId"] = $pageObject->getViewControl("DevoteeExtraInfoId")->showDBValue($row, "");
			$values["DevoteeId1"] = $pageObject->getViewControl("DevoteeId1")->showDBValue($row, "");
			$values["NativeCity"] = $pageObject->getViewControl("NativeCity")->showDBValue($row, "");
			$values["NativeState"] = $pageObject->getViewControl("NativeState")->showDBValue($row, "");
			$values["BloodGroup"] = $pageObject->getViewControl("BloodGroup")->showDBValue($row, "");
			$values["FatherName"] = $pageObject->getViewControl("FatherName")->showDBValue($row, "");
			$values["MotherName"] = $pageObject->getViewControl("MotherName")->showDBValue($row, "");
			$values["DevoteeLanguageId"] = $pageObject->getViewControl("DevoteeLanguageId")->showDBValue($row, "");
			$values["DevoteeId2"] = $pageObject->getViewControl("DevoteeId2")->showDBValue($row, "");
			$values["SpeakingLevel"] = $pageObject->getViewControl("SpeakingLevel")->showDBValue($row, "");
			$values["ReadingLevel"] = $pageObject->getViewControl("ReadingLevel")->showDBValue($row, "");
			$values["WritingLevel"] = $pageObject->getViewControl("WritingLevel")->showDBValue($row, "");
			$values["LanguageId"] = $pageObject->getViewControl("LanguageId")->showDBValue($row, "");
		...
		if ($eventRes)
		{
			...
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["CounsellorDevoteeID"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["DevoteeExtraInfoId"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["DevoteeId1"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["NativeCity"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["NativeState"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["BloodGroup"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["FatherName"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["MotherName"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["DevoteeLanguageId"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["DevoteeId2"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["SpeakingLevel"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["ReadingLevel"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["WritingLevel"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["LanguageId"]).'"';
			echo $outstr;
		}
...
// write header
	...
	if($_REQUEST["type"]=="excel")
	{
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Counsellor Devotee ID").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Devotee Extra Info Id").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Devotee Id1").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Native City").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Native State").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Blood Group").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Father Name").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Mother Name").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Devotee Language Id").'</td>';	
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Devotee Id2").'</td>';	
	...
	else
	{
		...
		echo "<td>"."Counsellor Devotee ID"."</td>";
		echo "<td>"."Devotee Extra Info Id"."</td>";
		echo "<td>"."Devotee Id1"."</td>";
		echo "<td>"."Native City"."</td>";
		echo "<td>"."Native State"."</td>";
		echo "<td>"."Blood Group"."</td>";
		echo "<td>"."Father Name"."</td>";
		echo "<td>"."Mother Name"."</td>";
		echo "<td>"."Devotee Language Id"."</td>";
		echo "<td>"."Devotee Id2"."</td>";
	...
	while((!$nPageSize || $iNumberOfRows<$nPageSize) && $row)
	{
		...
		if ($eventRes)
		{
			...
			echo '</td>';
					...
					echo $values["MaritalStatusId"];//echo htmlspecialchars($values["MaritalStatusId"]); commented for bug #6823
			...
			echo '</td>';
							echo '<td>';
									...
									echo $values["CounsellorDevoteeID"];
			echo '</td>';
							echo '<td>';
			
									echo $values["DevoteeExtraInfoId"];
			echo '</td>';
							echo '<td>';
			
									echo $values["DevoteeId1"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["NativeCity"]);
					else
						echo $values["NativeCity"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["NativeState"]);
					else
						echo $values["NativeState"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["BloodGroup"]);
					else
						echo $values["BloodGroup"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["FatherName"]);
					else
						echo $values["FatherName"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["MotherName"]);
					else
						echo $values["MotherName"];
			echo '</td>';
							echo '<td>';
			
									echo $values["DevoteeLanguageId"];
			echo '</td>';
							echo '<td>';
			
									echo $values["DevoteeId2"];
			echo '</td>';
							echo '<td>';
			
									echo $values["SpeakingLevel"];
			echo '</td>';
							echo '<td>';
			
									echo $values["ReadingLevel"];
			echo '</td>';
							echo '<td>';
			
									echo $values["WritingLevel"];
			echo '</td>';
							echo '<td>';
