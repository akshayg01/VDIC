...
$layout->blocks["top"][] = "search";$page_layouts["vw_counsellee_temp_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = "vw_counsellee_temp_search.htm";
...
$params['shortTableName'] = 'vw_counsellee_temp';
...
if ($mode==SEARCH_SIMPLE)
{
	...
	if($pageObject->pSet->getLookupTable("IsCounsellor"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("IsCounsellor")] = GetTableURL($pageObject->pSet->getLookupTable("IsCounsellor"));
	
	$pageObject->fillFieldToolTips("IsCounsellor");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("IsCounsellor");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "IsCounsellor";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("IsCounsellor_label","<label for=\"".GetInputElementId("IsCounsellor", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("IsCounsellor_label", true);
	
	$xt->assign("IsCounsellor_fieldblock", true);
	$xt->assignbyref("IsCounsellor_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("IsCounsellor_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("IsCounsellor_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_IsCounsellor", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("IsCounsellor");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"IsCounsellor", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"IsCounsellor", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	...
	if($pageObject->pSet->getLookupTable("DateOfHarinamInitiation"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("DateOfHarinamInitiation")] = GetTableURL($pageObject->pSet->getLookupTable("DateOfHarinamInitiation"));
	
	$pageObject->fillFieldToolTips("DateOfHarinamInitiation");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("DateOfHarinamInitiation");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "DateOfHarinamInitiation";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("DateOfHarinamInitiation_label","<label for=\"".GetInputElementId("DateOfHarinamInitiation", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("DateOfHarinamInitiation_label", true);
	
	$xt->assign("DateOfHarinamInitiation_fieldblock", true);
	$xt->assignbyref("DateOfHarinamInitiation_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("DateOfHarinamInitiation_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("DateOfHarinamInitiation_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_DateOfHarinamInitiation", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("DateOfHarinamInitiation");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"DateOfHarinamInitiation", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"DateOfHarinamInitiation", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
