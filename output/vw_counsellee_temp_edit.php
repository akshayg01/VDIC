...
$layout->blocks["top"][] = "details";$page_layouts["vw_counsellee_temp_edit"] = $layout;
...
$templatefile = ($inlineedit == EDIT_INLINE) ? "vw_counsellee_temp_inline_edit.htm" : "vw_counsellee_temp_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: vw_counsellee_temp_".$pageObject->getPageType().".php?".$keyGetQ);
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='vw_counsellee_temp_view.php?".$viewlink."'\"");
