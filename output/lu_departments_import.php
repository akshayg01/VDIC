...
// keys array
$keys[]=AddFieldWrappers("DepartmentId");
$keys_present=1;
...
function ImportFromExcel($uploadfile)
{
	...
	for($k=0; $k<count($keys); $k++)
	{
		...
		if(in_array("DepartmentId",$fields))
		$autoinc=true;
...
$layout->blocks["top"][] = "import";$page_layouts["lu_departments_import"] = $layout;
...
$xt->display("lu_departments_import.htm");
