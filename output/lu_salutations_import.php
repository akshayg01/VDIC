...
// keys array
$keys[]=AddFieldWrappers("SalutationId");
$keys_present=1;
...
function ImportFromExcel($uploadfile)
{
	...
	for($k=0; $k<count($keys); $k++)
	{
		...
		if(in_array("SalutationId",$fields))
		$autoinc=true;
...
$layout->blocks["top"][] = "import";$page_layouts["lu_salutations_import"] = $layout;
...
$xt->display("lu_salutations_import.htm");
