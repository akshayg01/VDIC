...
$layout->blocks["top"][] = "pdf";$page_layouts["lu_life_membership_status_print"] = $layout;
...
//	LifeMembershipStatusId - 
			$record["LifeMembershipStatusId_value"] = $pageObject->showDBValue("LifeMembershipStatusId", $data, $keylink);
			$record["LifeMembershipStatusId_class"] = $pageObject->fieldClass("LifeMembershipStatusId");
//	status - 
...
$xt->assign("LifeMembershipStatusId_fieldheadercolumn",true);
$xt->assign("LifeMembershipStatusId_fieldheader",true);
$xt->assign("LifeMembershipStatusId_fieldcolumn",true);
$xt->assign("LifeMembershipStatusId_fieldfootercolumn",true);
