...
include("include/vw_all_devotee_variables.php");
...
$layout->blocks["top"][] = "search";$page_layouts["vw_all_devotee_search"] = $layout;
...
$mode = SEARCH_SIMPLE;
$templatefile = "vw_all_devotee_search.htm";
...
$params['shortTableName'] = 'vw_all_devotee';
...
if ($mode==SEARCH_SIMPLE)
{
	...
	if($pageObject->pSet->getLookupTable("CounsellorID"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("CounsellorID")] = GetTableURL($pageObject->pSet->getLookupTable("CounsellorID"));
	
	$pageObject->fillFieldToolTips("CounsellorID");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("CounsellorID");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "CounsellorID";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("CounsellorID_label","<label for=\"".GetInputElementId("CounsellorID", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("CounsellorID_label", true);
	
	$xt->assign("CounsellorID_fieldblock", true);
	$xt->assignbyref("CounsellorID_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("CounsellorID_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("CounsellorID_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_CounsellorID", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("CounsellorID");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"CounsellorID", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"CounsellorID", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
	...
	if($pageObject->pSet->getLookupTable("Counsellor"))
		$pageObject->settingsMap["globalSettings"]['shortTNames'][$pageObject->pSet->getLookupTable("Counsellor")] = GetTableURL($pageObject->pSet->getLookupTable("Counsellor"));
	
	$pageObject->fillFieldToolTips("Counsellor");	
	
	$srchFields = $pageObject->searchClauseObj->getSearchCtrlParams("Counsellor");
	$firstFieldParams = array();
	if (count($srchFields))
	{
		$firstFieldParams = $srchFields[0];
	...
	{
		$firstFieldParams['fName'] = "Counsellor";
		$firstFieldParams['eType'] = '';
		$firstFieldParams['value1'] = '';
		$firstFieldParams['opt'] = '';
		$firstFieldParams['value2'] = '';
	...
	if(isEnableSection508())
		$xt->assign_section("Counsellor_label","<label for=\"".GetInputElementId("Counsellor", $id, PAGE_SEARCH)."\">","</label>");
	else 
		$xt->assign("Counsellor_label", true);
	
	$xt->assign("Counsellor_fieldblock", true);
	$xt->assignbyref("Counsellor_editcontrol", $ctrlBlockArr['searchcontrol']);
	$xt->assign("Counsellor_notbox", $ctrlBlockArr['notbox']);
	// create second control, if need it
	$xt->assignbyref("Counsellor_editcontrol1", $ctrlBlockArr['searchcontrol1']);
	// create search type select
	$xt->assign("searchtype_Counsellor", $ctrlBlockArr['searchtype']);
	$isFieldNeedSecCtrl = $searchControlBuilder->isNeedSecondCtrl("Counsellor");
	$ctrlInd = 0;
	if ($isFieldNeedSecCtrl)
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"Counsellor", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd, 1=>($ctrlInd+1)));
		$ctrlInd+=2;
	}
	else
	{
		$pageObject->controlsMap["search"]["searchBlocks"][] = array('fName'=>"Counsellor", 'recId'=>$id, 'ctrlsMap'=>array(0=>$ctrlInd));			
		$ctrlInd++;
	}
	// search fields data
