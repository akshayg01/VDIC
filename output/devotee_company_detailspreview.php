...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["devotee_company_detailspreview"] = $layout;
...
if($rowcount) {
	...
	//	DevoteeCompanyId - 
		    ...
		    $value = $viewContainer->showDBValue("DevoteeCompanyId", $data, $keylink);
			$row["DevoteeCompanyId_value"] = $value;
	//	DevoteeId - 
			$viewContainer->recId = $recordsCounter;
...
$xt->load_template("devotee_company_detailspreview.htm");
