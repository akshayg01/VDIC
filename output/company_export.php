...
$layout->blocks["top"][] = "export";$page_layouts["company_export"] = $layout;
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=company.xml");
	...
	{
		$values = array();
			$values["CompanyName"] = $pageObject->showDBValue("CompanyName", $row);
			$values["Address Line1"] = $pageObject->showDBValue("Address Line1", $row);
			$values["Address Line2"] = $pageObject->showDBValue("Address Line2", $row);
			$values["City"] = $pageObject->showDBValue("City", $row);
			$values["State"] = $pageObject->showDBValue("State", $row);
			$values["PIN Code"] = $pageObject->showDBValue("PIN Code", $row);
...
// write header
	...
	if($outstr!="")
		$outstr.=",";
	$outstr.= "\"Address Line1\"";
	if($outstr!="")
		$outstr.=",";
	$outstr.= "\"Address Line2\"";
	if($outstr!="")
		$outstr.=",";
	$outstr.= "\"City\"";
	if($outstr!="")
...
// write data rows
	...
	{
		$values = array();
			$values["CompanyName"] = $pageObject->getViewControl("CompanyName")->showDBValue($row, "");
			$values["Address Line1"] = $pageObject->getViewControl("Address Line1")->showDBValue($row, "");
			$values["Address Line2"] = $pageObject->getViewControl("Address Line2")->showDBValue($row, "");
			$values["City"] = $pageObject->getViewControl("City")->showDBValue($row, "");
			$values["State"] = $pageObject->getViewControl("State")->showDBValue($row, "");
			$values["PIN Code"] = $pageObject->getViewControl("PIN Code")->showDBValue($row, "");
		...
		if ($eventRes)
		{
			...
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["CompanyName"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["Address Line1"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["Address Line2"]).'"';
			if($outstr!="")
				$outstr.=",";
			...
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["PIN Code"]).'"';
			if($outstr!="")
				$outstr.=",";
...
// write header
	...
	if($_REQUEST["type"]=="excel")
	{
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("PIN Code").'</td>';	
		...
		if ($eventRes)
		{
			...
			echo "<tr>";
					...
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["CompanyName"]);
					else
			...
			echo '</td>';
					...
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["Address Line1"]);
					else
						echo $values["Address Line1"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["Address Line2"]);
					else
						echo $values["Address Line2"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
			...
			echo '</td>';
					...
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["PIN Code"]);
					else
						echo $values["PIN Code"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
