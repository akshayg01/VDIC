...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["devotee_language_detailspreview"] = $layout;
...
if($rowcount) {
	...
	//	LanguageId - 
		    ...
		    $value = $viewContainer->showDBValue("LanguageId", $data, $keylink);
			$row["LanguageId_value"] = $value;
	//	SpeakingLevel - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("SpeakingLevel", $data, $keylink);
			$row["SpeakingLevel_value"] = $value;
	//	ReadingLevel - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("ReadingLevel", $data, $keylink);
			$row["ReadingLevel_value"] = $value;
	//	WritingLevel - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("WritingLevel", $data, $keylink);
			$row["WritingLevel_value"] = $value;
		$rowinfo[] = $row;
		$data = $cipherer->DecryptFetchedArray($rs);
	}
...
$xt->load_template("devotee_language_detailspreview.htm");
