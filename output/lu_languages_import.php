...
// keys array
$keys[]=AddFieldWrappers("LanguageId");
$keys_present=1;
...
$layout->blocks["top"][] = "import";$page_layouts["lu_languages_import"] = $layout;
...
$xt->display("lu_languages_import.htm");
