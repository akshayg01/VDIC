...
// keys array
$keys[]=AddFieldWrappers("CounsellorCounselleeID");
$keys_present=1;
...
function ImportFromExcel($uploadfile)
{
	...
	for($k=0; $k<count($keys); $k++)
	{
		...
		if(in_array("CounsellorCounselleeID",$fields))
		$autoinc=true;
...
$layout->blocks["top"][] = "import";$page_layouts["counsellor_counsellee_import"] = $layout;
...
$xt->display("counsellor_counsellee_import.htm");
