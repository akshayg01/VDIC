...
// keys array
$keys[]=AddFieldWrappers("DonationId");
$keys_present=1;
...
$layout->blocks["top"][] = "import";$page_layouts["devotee_donation_import"] = $layout;
...
$xt->display("devotee_donation_import.htm");
