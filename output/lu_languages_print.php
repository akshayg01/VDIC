...
$layout->blocks["top"][] = "pdf";$page_layouts["lu_languages_print"] = $layout;
...
//	language - 
			$record["language_value"] = $pageObject->showDBValue("language", $data, $keylink);
			$record["language_class"] = $pageObject->fieldClass("language");
			if($col<$colsonpage)
