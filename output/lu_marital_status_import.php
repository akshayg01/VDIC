...
// keys array
$keys[]=AddFieldWrappers("MaritalStatusId");
$keys_present=1;
...
function ImportFromExcel($uploadfile)
{
	...
	for($k=0; $k<count($keys); $k++)
	{
		...
		if(in_array("MaritalStatusId",$fields))
		$autoinc=true;
...
$layout->blocks["top"][] = "import";$page_layouts["lu_marital_status_import"] = $layout;
...
$xt->display("lu_marital_status_import.htm");
