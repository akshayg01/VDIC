...
// keys array
$keys[]=AddFieldWrappers("DonationPurposeId");
$keys_present=1;
...
function ImportFromExcel($uploadfile)
{
	...
	for($k=0; $k<count($keys); $k++)
	{
		...
		if(in_array("DonationPurposeId",$fields))
		$autoinc=true;
...
$layout->blocks["top"][] = "import";$page_layouts["lu_donation_purpose_import"] = $layout;
...
$xt->display("lu_donation_purpose_import.htm");
