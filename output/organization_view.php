...
$layout->blocks["top"][] = "details";$page_layouts["organization_view"] = $layout;
...
//OrgName - 
	...
	if($mainTableOwnerID=="OrgName")
		$ownerIdValue=$value;
	$xt->assign("OrgName_value",$value);
...
//OrgOwnerId - 
	...
	if($mainTableOwnerID=="OrgOwnerId")
		$ownerIdValue=$value;
	$xt->assign("OrgOwnerId_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='organization_edit.php?".$editlink."'\"");
