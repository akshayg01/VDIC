...
// keys array
$keys[]=AddFieldWrappers("FamilyMemberId");
$keys_present=1;
...
function ImportFromExcel($uploadfile)
{
	...
	for($k=0; $k<count($keys); $k++)
	{
		...
		if(in_array("FamilyMemberId",$fields))
		$autoinc=true;
...
$layout->blocks["top"][] = "import";$page_layouts["devotee_family_member_import"] = $layout;
...
$xt->display("devotee_family_member_import.htm");
