...
$layout->blocks["top"][] = "pdf";$page_layouts["lu_banks_print"] = $layout;
...
//	BankId - 
			$record["BankId_value"] = $pageObject->showDBValue("BankId", $data, $keylink);
			$record["BankId_class"] = $pageObject->fieldClass("BankId");
//	Name - 
...
$xt->assign("BankId_fieldheadercolumn",true);
$xt->assign("BankId_fieldheader",true);
$xt->assign("BankId_fieldcolumn",true);
$xt->assign("BankId_fieldfootercolumn",true);
