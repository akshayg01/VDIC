...
// keys array
$keys[]=AddFieldWrappers("IsCounsellorId");
$keys_present=1;
...
function ImportFromExcel($uploadfile)
{
	...
	for($k=0; $k<count($keys); $k++)
	{
		...
		if(in_array("IsCounsellorId",$fields))
		$autoinc=true;
...
$layout->blocks["top"][] = "import";$page_layouts["lu_iscounsellor_import"] = $layout;
...
$xt->display("lu_iscounsellor_import.htm");
