...
$layout->blocks["top"][] = "details";$page_layouts["vw_OwnProfile_view"] = $layout;
...
//MaritalStatus - 
	...
	if($mainTableOwnerID=="MaritalStatus")
		$ownerIdValue=$value;
	$xt->assign("MaritalStatus_value",$value);
...
//SpouseName - 
	...
	if($mainTableOwnerID=="SpouseName")
		$ownerIdValue=$value;
	$xt->assign("SpouseName_value",$value);
...
//CounsellorName - 
	...
	if($mainTableOwnerID=="CounsellorName")
		$ownerIdValue=$value;
	$xt->assign("CounsellorName_value",$value);
	if(!$pageObject->isAppearOnTabs("CounsellorName"))
		$xt->assign("CounsellorName_fieldblock",true);
	else
		$xt->assign("CounsellorName_tabfieldblock",true);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='vw_OwnProfile_edit.php?".$editlink."'\"");
