...
// keys array
$keys[]=AddFieldWrappers("DevoteeCompanyId");
$keys_present=1;
...
function ImportFromExcel($uploadfile)
{
	...
	for($k=0; $k<count($keys); $k++)
	{
		...
		if(in_array("DevoteeCompanyId",$fields))
		$autoinc=true;
...
$layout->blocks["top"][] = "import";$page_layouts["devotee_company_import"] = $layout;
...
$xt->display("devotee_company_import.htm");
