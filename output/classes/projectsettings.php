...
function GetTableURL($table = "")
{
	...
	if(!$table)
		$table=$strTableName;
	if("devotee_address" == $table) 
		return "devotee_address";
	if("company" == $table) 
		return "company";
	if("devotee" == $table) 
		return "devotee";
	if("devotee_donation" == $table) 
		return "devotee_donation";
	if("devotee_language" == $table) 
		return "devotee_language";
	if("devotee_org" == $table) 
		return "devotee_org";
	if("devotee_family_member" == $table) 
		return "devotee_family_member";
	if("lu_family_relationship" == $table) 
		return "lu_family_relationship";
	if("lu_banks" == $table) 
		return "lu_banks";
	if("lu_departments" == $table) 
		return "lu_departments";
	if("lu_initiating_gurus" == $table) 
		return "lu_initiating_gurus";
	if("lu_languages" == $table) 
		return "lu_languages";
	if("lu_life_membership_status" == $table) 
		return "lu_life_membership_status";
	if("lu_marital_status" == $table) 
		return "lu_marital_status";
	if("lu_message_types" == $table) 
		return "lu_message_types";
	if("lu_request_types" == $table) 
		return "lu_request_types";
	if("lu_salutations" == $table) 
		return "lu_salutations";
	if("organization" == $table) 
		return "organization";
	if("devotee_company" == $table) 
		return "devotee_company";
	if("lu_donation_purpose" == $table) 
		return "lu_donation_purpose";
	if("lu_payment_modes" == $table) 
		return "lu_payment_modes";
	...
	if("admin_users" == $table) 
		return "admin_users";
	if("counsellor_counsellee" == $table) 
		return "counsellor_counsellee";
	if("vw_counsellee" == $table) 
		return "vw_counsellee";
	if("vw_OwnProfile" == $table) 
		return "vw_OwnProfile";
	if("vw_all_devotee" == $table) 
		return "vw_all_devotee";
	if("vw_Devotee_full" == $table) 
		return "vw_Devotee_full";
	if("vw_counsellee_temp" == $table) 
		return "vw_counsellee_temp";
	if("vw_counsellors" == $table) 
		return "vw_counsellors";
	if("spiritualmaster" == $table) 
		return "spiritualmaster";
	if("lu_iscounsellor" == $table) 
		return "lu_iscounsellor";
	if("lu_pin_city_state" == $table) 
		return "lu_pin_city_state";
}
...
{	
	...
	if(!$shortTName)
		return false;
	if("devotee_address" == $shortTName) 
		return "devotee_address";
	if("company" == $shortTName) 
		return "company";
	if("devotee" == $shortTName) 
		return "devotee";
	if("devotee_donation" == $shortTName) 
		return "devotee_donation";
	if("devotee_language" == $shortTName) 
		return "devotee_language";
	if("devotee_org" == $shortTName) 
		return "devotee_org";
	if("devotee_family_member" == $shortTName) 
		return "devotee_family_member";
	if("lu_family_relationship" == $shortTName) 
		return "lu_family_relationship";
	if("lu_banks" == $shortTName) 
		return "lu_banks";
	if("lu_departments" == $shortTName) 
		return "lu_departments";
	if("lu_initiating_gurus" == $shortTName) 
		return "lu_initiating_gurus";
	if("lu_languages" == $shortTName) 
		return "lu_languages";
	if("lu_life_membership_status" == $shortTName) 
		return "lu_life_membership_status";
	if("lu_marital_status" == $shortTName) 
		return "lu_marital_status";
	if("lu_message_types" == $shortTName) 
		return "lu_message_types";
	if("lu_request_types" == $shortTName) 
		return "lu_request_types";
	if("lu_salutations" == $shortTName) 
		return "lu_salutations";
	if("organization" == $shortTName) 
		return "organization";
	if("devotee_company" == $shortTName) 
		return "devotee_company";
	if("lu_donation_purpose" == $shortTName) 
		return "lu_donation_purpose";
	if("lu_payment_modes" == $shortTName) 
		return "lu_payment_modes";
	...
	if("admin_users" == $shortTName) 
		return "admin_users";
	if("counsellor_counsellee" == $shortTName) 
		return "counsellor_counsellee";
	if("vw_counsellee" == $shortTName) 
		return "vw_counsellee";
	if("vw_OwnProfile" == $shortTName) 
		return "vw_OwnProfile";
	if("vw_all_devotee" == $shortTName) 
		return "vw_all_devotee";
	if("vw_Devotee_full" == $shortTName) 
		return "vw_Devotee_full";
	if("vw_counsellee_temp" == $shortTName) 
		return "vw_counsellee_temp";
	if("vw_counsellors" == $shortTName) 
		return "vw_counsellors";
	if("spiritualmaster" == $shortTName) 
		return "spiritualmaster";
	if("lu_iscounsellor" == $shortTName) 
		return "lu_iscounsellor";
	if("lu_pin_city_state" == $shortTName) 
		return "lu_pin_city_state";
}
