...
// keys array
$keys[]=AddFieldWrappers("DevoteeOrgId");
$keys_present=1;
...
function ImportFromExcel($uploadfile)
{
	...
	for($k=0; $k<count($keys); $k++)
	{
		...
		if(in_array("DevoteeOrgId",$fields))
		$autoinc=true;
...
$layout->blocks["top"][] = "import";$page_layouts["devotee_org_import"] = $layout;
...
$xt->display("devotee_org_import.htm");
