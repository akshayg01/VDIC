...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["devotee_org_detailspreview"] = $layout;
...
if($mastertable == "organization")
{
	$where = "";
		$where .= GetFullFieldName("OrgId", $strTableName, false)."=".make_db_value("OrgId",$_SESSION[$strTableName."_masterkey1"]);
}
...
if($rowcount) {
	...
	//	OrgId - 
		    ...
		    $value = $viewContainer->showDBValue("OrgId", $data, $keylink);
			$row["OrgId_value"] = $value;
	//	FromDate - Short Date
			$viewContainer->recId = $recordsCounter;
...
$xt->load_template("devotee_org_detailspreview.htm");
