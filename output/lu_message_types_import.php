...
// keys array
$keys[]=AddFieldWrappers("MessageTypeId");
$keys_present=1;
...
function ImportFromExcel($uploadfile)
{
	...
	for($k=0; $k<count($keys); $k++)
	{
		...
		if(in_array("MessageTypeId",$fields))
		$autoinc=true;
...
$layout->blocks["top"][] = "import";$page_layouts["lu_message_types_import"] = $layout;
...
$xt->display("lu_message_types_import.htm");
