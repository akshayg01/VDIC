...
function ImportFromExcel($uploadfile)
{
	...
	for($k=0; $k<count($keys); $k++)
	{
		...
		$autoinc=true;
																				if(in_array("DevoteeExtraInfoId",$fields))
		$autoinc=true;
								if(in_array("DevoteeLanguageId",$fields))
		$autoinc=true;
...
$layout->blocks["top"][] = "import";$page_layouts["vw_counsellee_import"] = $layout;
...
$xt->display("vw_counsellee_import.htm");
