...
// keys array
$keys[]=AddFieldWrappers("LifeMembershipStatusId");
$keys_present=1;
...
function ImportFromExcel($uploadfile)
{
	...
	for($k=0; $k<count($keys); $k++)
	{
		...
		if(in_array("LifeMembershipStatusId",$fields))
		$autoinc=true;
...
$layout->blocks["top"][] = "import";$page_layouts["lu_life_membership_status_import"] = $layout;
...
$xt->display("lu_life_membership_status_import.htm");
