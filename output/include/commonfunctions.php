...
function checkTableName($shortTName, $type=false)
{
	...
	if ("devotee_address" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("company" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("devotee" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("devotee_donation" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("devotee_language" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("devotee_org" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("devotee_family_member" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("lu_family_relationship" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("lu_banks" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("lu_departments" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("lu_initiating_gurus" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("lu_languages" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("lu_life_membership_status" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("lu_marital_status" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("lu_message_types" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("lu_request_types" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("lu_salutations" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("organization" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("devotee_company" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("lu_donation_purpose" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("lu_payment_modes" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	...
	if ("admin_users" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("counsellor_counsellee" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("vw_counsellee" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("vw_OwnProfile" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("vw_all_devotee" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("vw_Devotee_full" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("vw_counsellee_temp" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("vw_counsellors" == $shortTName && ($type===false || ($type!==false && $type == 1)))
		return true;
	if ("spiritualmaster" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("lu_iscounsellor" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	if ("lu_pin_city_state" == $shortTName && ($type===false || ($type!==false && $type == 0)))
		return true;
	return false;
}
...
{
	$arr = array();
	$strPerm = GetUserPermissions("devotee_address");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="devotee_address";
	}
	$strPerm = GetUserPermissions("company");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="company";
	}
	$strPerm = GetUserPermissions("devotee");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="devotee";
	}
	$strPerm = GetUserPermissions("devotee_donation");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="devotee_donation";
	}
	$strPerm = GetUserPermissions("devotee_language");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="devotee_language";
	}
	$strPerm = GetUserPermissions("devotee_org");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="devotee_org";
	}
	$strPerm = GetUserPermissions("devotee_family_member");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="devotee_family_member";
	}
	$strPerm = GetUserPermissions("lu_family_relationship");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="lu_family_relationship";
	}
	$strPerm = GetUserPermissions("lu_banks");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="lu_banks";
	}
	$strPerm = GetUserPermissions("lu_departments");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="lu_departments";
	}
	$strPerm = GetUserPermissions("lu_initiating_gurus");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="lu_initiating_gurus";
	}
	$strPerm = GetUserPermissions("lu_languages");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="lu_languages";
	}
	$strPerm = GetUserPermissions("lu_life_membership_status");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="lu_life_membership_status";
	}
	$strPerm = GetUserPermissions("lu_marital_status");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="lu_marital_status";
	}
	$strPerm = GetUserPermissions("lu_message_types");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="lu_message_types";
	}
	$strPerm = GetUserPermissions("lu_request_types");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="lu_request_types";
	}
	$strPerm = GetUserPermissions("lu_salutations");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="lu_salutations";
	}
	$strPerm = GetUserPermissions("organization");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="organization";
	}
	$strPerm = GetUserPermissions("devotee_company");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="devotee_company";
	}
	$strPerm = GetUserPermissions("lu_donation_purpose");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="lu_donation_purpose";
	}
	$strPerm = GetUserPermissions("lu_payment_modes");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="lu_payment_modes";
	}
	...
	$strPerm = GetUserPermissions("counsellor_counsellee");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="counsellor_counsellee";
	}
	$strPerm = GetUserPermissions("vw_counsellee");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="vw_counsellee";
	}
	$strPerm = GetUserPermissions("vw_OwnProfile");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="vw_OwnProfile";
	}
	$strPerm = GetUserPermissions("vw_all_devotee");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="vw_all_devotee";
	}
	$strPerm = GetUserPermissions("vw_Devotee_full");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="vw_Devotee_full";
	}
	$strPerm = GetUserPermissions("vw_counsellee_temp");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="vw_counsellee_temp";
	}
	$strPerm = GetUserPermissions("vw_counsellors");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="vw_counsellors";
	}
	$strPerm = GetUserPermissions("spiritualmaster");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="spiritualmaster";
	}
	$strPerm = GetUserPermissions("lu_iscounsellor");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="lu_iscounsellor";
	}
	$strPerm = GetUserPermissions("lu_pin_city_state");
	if(strpos($strPerm, "P")!==false || ($pdfMode && strpos($strPerm, "S")!==false))
	{
		$arr[]="lu_pin_city_state";
	}
	return $arr;
}
...
function ReadUserPermissions($userID="")
{
	...
	if($userID!="Guest")
	{
			...
			$sql = "select `GroupID`, `UserName` from `access1_ugmembers` where `UserName`=".db_prepare_string($userID);
		else
			$sql = "select `GroupID`, `UserName` from `access1_ugmembers` where `UserName`=".strtoupper(db_prepare_string($userID));
		$rs = db_query($sql,$conn);
	...
	$rights=array();
	$sql = "select `TableName`,`AccessMask` from `access1_ugrights` where `GroupID` in (".$groupstr.")";
	$rs = db_query($sql,$conn);
	while($data=db_fetch_numarray($rs))
	{
...
{	
	...
	if(!count($_SESSION["UserRights"]["Guest"]))
		return false;
	if(array_key_exists("devotee_address",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("company",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("devotee",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("devotee_donation",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("devotee_language",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("devotee_org",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("devotee_family_member",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("lu_family_relationship",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("lu_banks",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("lu_departments",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("lu_initiating_gurus",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("lu_languages",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("lu_life_membership_status",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("lu_marital_status",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("lu_message_types",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("lu_request_types",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("lu_salutations",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("organization",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("devotee_company",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("lu_donation_purpose",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("lu_payment_modes",$_SESSION["UserRights"]["Guest"]))
		return true;
	...
	if(array_key_exists("admin_users",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("counsellor_counsellee",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("vw_counsellee",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("vw_OwnProfile",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("vw_all_devotee",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("vw_Devotee_full",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("vw_counsellee_temp",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("vw_counsellors",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("spiritualmaster",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("lu_iscounsellor",$_SESSION["UserRights"]["Guest"]))
		return true;
	if(array_key_exists("lu_pin_city_state",$_SESSION["UserRights"]["Guest"]))
		return true;
	return false;
}
...
function inFacebook(){
	...
	if ($signed_request) {
		...
		$strSQL = "select * from ".AddTableWrappers("devotee")." where ".AddFieldWrappers(GetUserNameField())."='".$strUsername."'";
...
function AfterFBLogIn($pUsername, $pPassword){
	...
	$strSQL = "select * from ".AddTableWrappers("devotee")." where ".AddFieldWrappers($cUserNameField)."=".$strUsername."";
	$rs = db_query($strSQL,$conn);
 	$data = db_fetch_array($rs);
	if($data){
		$logged=true;
...
{
	global $globalEvents;
		$_SESSION["GroupID"] = $data["EmailPrimary"];
		if($_SESSION["GroupID"]=="Admin")
			$_SESSION["AccessLevel"] = ACCESS_LEVEL_ADMINGROUP;


			$_SESSION["OwnerID"] = $data["DevoteeId"];
		$_SESSION["_devotee_address_OwnerID"] = $data["DevoteeId"];
			$_SESSION["_devotee_OwnerID"] = $data["DevoteeId"];
			$_SESSION["_admin_members_OwnerID"] = $data["DevoteeId"];
			$_SESSION["_admin_users_OwnerID"] = $data["DevoteeId"];
			$_SESSION["_vw_counsellee_OwnerID"] = $data["DevoteeId"];
			$_SESSION["_vw_OwnProfile_OwnerID"] = $data["DevoteeId"];
			$_SESSION["_vw_all_devotee_OwnerID"] = $data["DevoteeId"];
			$_SESSION["_vw_Devotee_full_OwnerID"] = $data["DevoteeId"];
			$_SESSION["_vw_counsellee_temp_OwnerID"] = $data["DevoteeId"];
			$_SESSION["_vw_counsellors_OwnerID"] = $data["DevoteeId"];
...
function CheckSecurity($strValue, $strAction)
{
	...
	{
		if($strTableName=="devotee_address")
		{
		...
		if($strTableName=="vw_counsellee")
		{
			
				if(!($pSet->getCaseSensitiveUsername((string)$_SESSION["_".$strTableName."_OwnerID"])===$pSet->getCaseSensitiveUsername((string)$strValue)))
				return false;
		}
		if($strTableName=="vw_OwnProfile")
		{
			
				if(!($pSet->getCaseSensitiveUsername((string)$_SESSION["_".$strTableName."_OwnerID"])===$pSet->getCaseSensitiveUsername((string)$strValue)))
				return false;
		}
		if($strTableName=="vw_all_devotee")
		{
		...
		if($strTableName=="vw_Devotee_full")
		{
			
				if(!($pSet->getCaseSensitiveUsername((string)$_SESSION["_".$strTableName."_OwnerID"])===$pSet->getCaseSensitiveUsername((string)$strValue)))
				return false;
		}
		if($strTableName=="vw_counsellee_temp")
		{
...
function SecuritySQL($strAction, $table="")
{
	...
	if(strpos($strPerm,"M")===false)
	{
		...
		if($table=="vw_counsellee")
		{
				$ret=GetFullFieldName($pSet->getTableOwnerID(), $table, false)."=".make_db_value($pSet->getTableOwnerID(),$ownerid, "", "", $table);
		}
		if($table=="vw_OwnProfile")
		{
				$ret=GetFullFieldName($pSet->getTableOwnerID(), $table, false)."=".make_db_value($pSet->getTableOwnerID(),$ownerid, "", "", $table);
		}
		if($table=="vw_all_devotee")
		{
				if($strAction=="Edit" || $strAction=="Delete")
				$ret=GetFullFieldName($pSet->getTableOwnerID(), $table, false)."=".make_db_value($pSet->getTableOwnerID(),$ownerid, "", "", $table);
		}
		if($table=="vw_Devotee_full")
		{
				$ret=GetFullFieldName($pSet->getTableOwnerID(), $table, false)."=".make_db_value($pSet->getTableOwnerID(),$ownerid, "", "", $table);
		}
		if($table=="vw_counsellee_temp")
		{
				$ret=GetFullFieldName($pSet->getTableOwnerID(), $table, false)."=".make_db_value($pSet->getTableOwnerID(),$ownerid, "", "", $table);
		}
	}
