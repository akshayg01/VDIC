...
class AuditTrailTable
{
	...
	function logValueEnable($table)
	{
		...
		if($table=="devotee_donation")
		{
			return true;
		}
		if($table=="devotee_language")
		{
			return true;
		}
		if($table=="devotee_org")
		{
			return true;
		}
		if($table=="devotee_family_member")
		{
			return true;
		}
		if($table=="lu_family_relationship")
		{
			return true;
		}
		if($table=="lu_banks")
		...
		if($table=="lu_departments")
		{
			return true;
		}
		if($table=="lu_initiating_gurus")
		{
			return true;
		}
		if($table=="lu_languages")
		{
			return true;
		}
		if($table=="lu_life_membership_status")
		{
			return true;
		}
		if($table=="lu_marital_status")
		{
			return true;
		}
		if($table=="lu_message_types")
		{
			return true;
		}
		if($table=="lu_request_types")
		{
			return true;
		}
		if($table=="lu_salutations")
		{
			return true;
		}
		...
		if($table=="devotee_company")
		{
			return false;
		}
		if($table=="lu_donation_purpose")
		{
			return false;
		}
		if($table=="lu_payment_modes")
		{
			return false;
		}
		...
		if($table=="counsellor_counsellee")
		{
			return false;
		}
		...
		if($table=="vw_counsellors")
		{
			return true;
		}
		if($table=="spiritualmaster")
		{
			return false;
		}
		if($table=="lu_iscounsellor")
		{
			return false;
		}
		if($table=="lu_pin_city_state")
		{
			return false;
		}
	}
