...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["devotee_address_detailspreview"] = $layout;
...
if($rowcount) {
	...
	//	AddressLine1 - 
		    ...
		    $value = $viewContainer->showDBValue("AddressLine1", $data, $keylink);
			$row["AddressLine1_value"] = $value;
	//	AddressLine2 - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("AddressLine2", $data, $keylink);
			$row["AddressLine2_value"] = $value;
	//	City - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("City", $data, $keylink);
	...
	//	country - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("country", $data, $keylink);
			$row["country_value"] = $value;
	//	pincode - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("pincode", $data, $keylink);
			$row["pincode_value"] = $value;
	//	AddressTypeID - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("AddressTypeID", $data, $keylink);
			$row["AddressTypeID_value"] = $value;
		$rowinfo[] = $row;
		$data = $cipherer->DecryptFetchedArray($rs);
	}
...
$xt->load_template("devotee_address_detailspreview.htm");
