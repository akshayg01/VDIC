...
$layout->blocks["top"][] = "export";$page_layouts["devotee_address_export"] = $layout;
...
$xt->display("devotee_address_export.htm");

function ExportToExcel_old($cipherer)
{
	global $cCharset;
	header("Content-Type: application/vnd.ms-excel");
	header("Content-Disposition: attachment;Filename=devotee_address.xls");
...
function ExportToWord($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=devotee_address.doc");
...
function ExportToXML($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=devotee_address.xml");
	...
	{
		$values = array();
			$values["AddressLine1"] = $pageObject->showDBValue("AddressLine1", $row);
			$values["AddressLine2"] = $pageObject->showDBValue("AddressLine2", $row);
			...
			$values["pincode"] = $pageObject->showDBValue("pincode", $row);
			$values["AddressTypeID"] = $pageObject->showDBValue("AddressTypeID", $row);
			$values["IsVerified"] = $pageObject->showDBValue("IsVerified", $row);
...
function ExportToCSV($cipherer)
{
	...
	header("Content-Disposition: attachment;Filename=devotee_address.csv");
...
// write data rows
	...
	{
		$values = array();
			$values["AddressLine1"] = $pageObject->getViewControl("AddressLine1")->showDBValue($row, "");
			$values["AddressLine2"] = $pageObject->getViewControl("AddressLine2")->showDBValue($row, "");
			...
			$values["pincode"] = $pageObject->getViewControl("pincode")->showDBValue($row, "");
			$values["AddressTypeID"] = $pageObject->getViewControl("AddressTypeID")->showDBValue($row, "");
			$values["IsVerified"] = $pageObject->getViewControl("IsVerified")->showDBValue($row, "");
		...
		if ($eventRes)
		{
			...
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["AddressLine1"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["AddressLine2"]).'"';
			if($outstr!="")
				$outstr.=",";
			...
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["pincode"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["AddressTypeID"]).'"';
			if($outstr!="")
				$outstr.=",";
			$outstr.='"'.str_replace('"', '""', $values["IsVerified"]).'"';
			echo $outstr;
		}
...
// write header
	...
	if($_REQUEST["type"]=="excel")
	{
		...
		echo '<td style="width: 100" x:str>'.PrepareForExcel("Is Verified").'</td>';	
	}
	else
	{
		...
		if ($eventRes)
		{
			...
			echo "<tr>";
					...
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["AddressLine1"]);
					else
						echo $values["AddressLine1"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["AddressLine2"]);
					else
						echo $values["AddressLine2"];
			echo '</td>';
							if($_REQUEST["type"]=="excel")
					echo '<td x:str>';
				else
			...
			echo '</td>';
					...
					echo $values["City"];//echo htmlspecialchars($values["City"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["pincode"]);
					else
						echo $values["pincode"];
			echo '</td>';
							echo '<td>';
								...
								if($_REQUEST["type"]=="excel")
					echo PrepareForExcel($values["AddressTypeID"]);
				else
					echo $values["AddressTypeID"];//echo htmlspecialchars($values["AddressTypeID"]); commented for bug #6823
			...
			echo '</td>';
					...
					echo '<td>';
									...
									if($_REQUEST["type"]=="excel")
						echo PrepareForExcel($values["IsVerified"]);
					else
						echo $values["IsVerified"];
			echo '</td>';
			echo "</tr>";
		}
