...
//CompanyName - 
	...
	if($mainTableOwnerID=="CompanyName")
		$ownerIdValue=$value;
	$xt->assign("CompanyName_value",$value);
...
//Address Line1 - 
	...
	if($mainTableOwnerID=="Address Line1")
		$ownerIdValue=$value;
	$xt->assign("Address_Line1_value",$value);
...
//Address Line2 - 
	...
	if($mainTableOwnerID=="Address Line2")
		$ownerIdValue=$value;
	$xt->assign("Address_Line2_value",$value);
...
//PIN Code - 
	...
	if($mainTableOwnerID=="PIN Code")
		$ownerIdValue=$value;
	$xt->assign("PIN_Code_value",$value);
