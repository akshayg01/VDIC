...
// keys array
$keys[]=AddFieldWrappers("RelationshipId");
$keys_present=1;
...
function ImportFromExcel($uploadfile)
{
	...
	for($k=0; $k<count($keys); $k++)
	{
		...
		if(in_array("RelationshipId",$fields))
		$autoinc=true;
...
$layout->blocks["top"][] = "import";$page_layouts["lu_family_relationship_import"] = $layout;
...
$xt->display("lu_family_relationship_import.htm");
