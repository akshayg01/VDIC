...
include_once("include/devotee_address_settings.php");
include_once("include/devotee_donation_settings.php");
include_once("include/devotee_language_settings.php");
include_once("include/devotee_org_settings.php");
include_once("include/devotee_family_member_settings.php");
include_once("include/devotee_company_settings.php");
include_once("include/counsellor_counsellee_settings.php");
...
$layout->blocks["top"][] = "search";$page_layouts["devotee_list"] = $layout;
