...
// keys array
$keys[]=AddFieldWrappers("GurumaharajId");
$keys_present=1;
...
function ImportFromExcel($uploadfile)
{
	...
	for($k=0; $k<count($keys); $k++)
	{
		...
		if(in_array("GurumaharajId",$fields))
		$autoinc=true;
...
$layout->blocks["top"][] = "import";$page_layouts["lu_initiating_gurus_import"] = $layout;
...
$xt->display("lu_initiating_gurus_import.htm");
